...
<div class="lines">
<ul class="no-bullets">
<li class="cat"><button id="btn1" class="click"><img src="https://images.unsplash.com/photo-1561948955-570b270e7c36?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" title:"cat.jpeg" style="max-height: 50px; min-height: 50px; min-width:50px; max-width:50px;"><div id="one"> ${cat}</div></button></li>
<li class="couple"><button id="btn2" class="click"><img src="https://images.unsplash.com/photo-1606787620819-8bdf0c44c293?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" style="max-height: 50px; min-height:50px; min-width:50px; max-width:50px;"><div id="two"> ${couple}</div></button></li>
<li class="beach"><button id="btn3" class="click"><img src="https://images.unsplash.com/photo-1539367628448-4bc5c9d171c8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" title:"cat.jpeg" style="max-height: 50px; min-height:50px; min-width:50px; max-width:50px;"><div id="three"> ${beach}</div></button></li>
<li class="pitch"><button id="btn4" class="click"><img src="https://images.unsplash.com/photo-1623206837956-07dab21608f6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" title:"cat.jpeg" style="max-height: 50px; min-height:50px; min-width:50px; max-width:50px;"><div id="four"> ${pitch}</div></button></li>
<li class="report"><button id="btn5" class="click"><img src="https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"" title:"cat.jpeg" style="max-height: 50px; min-height:50px; min-width:50px; max-width:50px;"><div id="five"> ${report}</div></button></li>
</ul>
</div>
<div><ul>
<li><img id="imag" src=${sourc} height="800" width="500"></li>
